...
```{r}
tax2 <- as.data.frame(taxa)


tax2$Kingdom<-str_replace_all(tax2$Kingdom,c("k__"),"")
tax2$Phylum<-str_replace_all(tax2$Kingdom,c("p__"),"")
tax2$Class<-str_replace_all(tax2$Class,c("c__"),"")
tax2$Order<-str_replace_all(tax2$Order,c("o__"),"")
tax2$Family<-str_replace_all(tax2$Family,c("f__"),"")
tax2$Genus<-str_replace_all(tax2$Genus,c("g__"),"")
tax2$Species<-str_replace_all(tax2$Species,c("s__"),"")

saveRDS(tax2,"taxtab2.rds")
